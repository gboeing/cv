...
% packages for contact info icons
\usepackage[pro]{fontawesome5} % remove pro option if you don't own a pro license
\usepackage{xcolor} % to color the icons gray (needs pro above)
...
\setsansfont{TeX Gyre Heros} % document's sans serif typeface
...
\begin{document}
    ...
    \begin{minipage}[t]{0.31\textwidth}
        % contact info icons, right-aligned
        \flushright~\color{darkgray}
        \faIcon[light]{envelope}\\
        \faIcon[light]{phone}\\
        \faIcon[light]{globe}
    \end{minipage}
    ...
    \begin{tablist}
        ...
        \item[2009--13] \tab Accenture\\
                             ...
                             New York, New York; London, England; San Diego, California
