...
\begin{document}
    ...
    \begin{tablist}
        ...
        %\item[\the\year] \tab{}G. Boeing. \enquote{Graph Simplification Solutions to the Street Intersection Miscount Problem.} \textit{International Journal of Geographical Information Science}, under review.

        %\item[\the\year] \tab{}G. Boeing and J. Ha. \enquote{Resilient Livelihoods: The Vulnerability of Commutes to Street Network Disruption.} \textit{Journal of Transport Geography}, under review.
        ...
        %\item[\the\year] \tab{}M. Lowe, et al. \enquote{Large Public Urban Green Space Indicators Using Open Data Validated for Diverse Cities Worldwide.} \textit{Sustainable Cities and Society}, in preparation.
