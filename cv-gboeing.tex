...
\usepackage[pro]{fontawesome5} % change pro -> regular if you don't own a pro license
...
\setsansfont{TeX Gyre Heros}  % document's sans serif font
...
\SetTracking{encoding=*, family=\ssfamily}{50}
