...
\begin{document}
    ...
    \begin{tablist}
        ...
        %\item[\the\year] \tab{}M. Lore, J.~G. Harten, and G. Boeing. \enquote{A Hybrid Deep Learning Method for Identifying Topics in Large-Scale Urban Text Data: Benefits and Trade-offs.} \textit{Computers, Environment and Urban Systems}, under review.

        %\item[\the\year] \tab{}M. Nieuwenhuijsen, G. Dyer, S. Khomenko, D. Adlakha, S. Anenberg, M. Behnisch, G. Boeing, M. Esperon-Rodriguez, A. Gasparrini, H. Khreis, M. Kondo, P. Masselot, R. McDonald, F. Montana, R. Mitchell, N. Mueller, M.~O. Nawaz, E. Pisoni, R. Prieto-Curiel, N. Rezaei, H. Taubenböck, C. Tonne, and D. Velázquez-Cortés. \enquote{Exploring the Nexus of Urban Form, Transport, Environment and Health in Large-Scale Urban Studies: A Scoping Review.} \textit{Environmental Research}, under review.

        %\item[\the\year] \tab{}M. Nieuwenhuijsen, G. Dyer, S. Khomenko, D. Adlakha, S. Anenberg, J. Angelova, M. Behnisch, G. Boeing, X. Chen, M. Cirach, K. de Hoogh, A. Diez Roux, M. Esperon-Rodriguez, B. Flueckiger, A. Gasparrini, H. Khreis, M. Kondo, T. Lungman, P. Masselot, R. McDonald, F. Montana, R. Mitchell, N. Mueller, M.~O. Nawaz, E. Pereira, E. Pisoni, R. Prieto-Curiel, J. Ramasco, N. Rezaei, D. Rybski, R. Schifanella, S. Shabou, L. Tatah, H. Taubenböck, C. Tonne, D. Velázquez-Cortés, J. Woodcock, Q. Zhang. \enquote{A Road Map for Future Data-Driven Urban Planning and Environmental Health Research.} \textit{Nature}, under review.
    ...
    \begin{tablist}
        ...
        %\item[2024] \tab{}G. Boeing and J. Ha. \enquote{Vulnerability of Commutes: A Nationwide Simulation of Street Network Disruptions across US Metropolitan Areas.} Association of Collegiate Schools of Planning Annual Conference. Seattle, Washington. Nov 7--9.
   ...
   \item The Public Good Projects, New York, New York, 2024--
   ...
   \end{itemize}
    ...
    \begin{itemize}
        ...
        \item Executive Committee, Global Observatory of Healthy and Sustainable Cities, 2022--
    ...
    \begin{itemize}
        \item USC Price School Dean Search Committee, 2024--
        \item USC Price Research Committee, 2020--21, 2024--
        \item USC Price Ph.D. Degree Committee, 2020--
