...
\begin{document}
    ...
    \begin{tablist}
    	...
    	\item[2019] \tab Boeing, G., M. Besbris, A. Schachter, and J. Kuk. \enquote{Housing Search in the Age of Big Data: Smarter Cities or the Same Old Blind Spots?} \textit{Housing Policy Debate} in press. \href{https://doi.org/10.1080/10511482.2019.1684336}{doi:10.1080/10511482.2019.1684336}
    	
    	\item[2019] \tab Boeing, G. \enquote{Urban Street Network Analysis in a Computational Notebook.} \textit{Region: Journal of the European Regional Science Association} in press.
    ...
    \begin{tablist}
        ...
        \item[\the\year] \tab Boeing, G. \enquote{Off the Grid: The Evolution of American Street Network Planning and Design.} Under review at \textit{Journal of the American Planning Association}.
    ...
    \begin{tablist}
        ...
        \item[\the\year] \tab Boeing, G. \enquote{The Right Tools for the Job: Reflections on GIScience Tool-Building.} Target: \textit{Transactions in GIS}, Spring 2020.
    ...
    \begin{tablist}
    	...
    	\item[2020] \tab Boeing, G. \enquote{Off the Grid: The Evolution of American Street Network Planning and Design.} Western Regional Science Association Annual Meeting. Honolulu, Hawaii. Mar 18--21.
    ...
    \begin{itemize}
    	...
    	\item Hiring Search Committee (environmental planning position), USC DUPSA, 2019--20
