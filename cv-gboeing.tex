...
\begin{document}
    ...
    \begin{tablist}
        ...
        %\item[\the\year] \tab{}R. Turner, C. Higgs, C. Sun, E. Resendiz, K. Peng, X. Cheng, R. Hunter, G. Boeing, D. Pugacheva, R. Chen, D. Adlakha, V. Kedar, G. Longo Rosa, A. Oyeyemi, R. Schifanella, P. Serra del Pozo, G. Peraza-Mues, J. Valson, E. Cerin, A. Puig-Ribera, E. Hinckson, and M. Lowe. \enquote{Development and Validation of the Global Urban Heat Vulnerability Index (GUHVI).} \textit{Journal Name}, under review.

        \item[2025] \tab{}M. Barthelemy and G. Boeing. \enquote{A Universal Model of Urban Street Networks.} \textit{Physical Review Letters}, in press.
        ...
        \item[2025] \tab{}R. Turner, C. Higgs, V. Heikinheimo, R. Hunter, J. Celso Borello Vargas, S. Liu, E. Resendiz, G. Boeing, D. Adlakha, R. Schifanella, G. Longo Rosa, D. Pugacheva, R. Chen, M. Baghaie Poor, J. Molina-García, A. Queralt, A. Puig-Ribera, P. Serra del Pozo, C. Garza, J. Valson, D. Salvo, E. Cerin, E. Hinckson, and M. Lowe \enquote{Validated Global Indicators of Large Public Urban Green Space Using Open Data.} \textit{Geographical Analysis}, published online ahead of print. \href{https://doi.org/10.1111/gean.70023}{doi:10.1111/gean.70023}
    ...
    \item[2025] \tab{}\enquote{AI and Urban Infrastructure Network Resilience to Flooding.} Bloomberg Center for Cities Research Conference. Harvard University. Cambridge, Massachusetts. Nov 13--14.
    ...
    \begin{tablist}
        ...
        \item[2025] \tab{}\enquote{The State of Urban Spatial Analytics Education: Challenges and Opportunities in an Evolving Field.} Panelist with Sarah Williams, Xiofan Liang, Shenhao Wang, Xiaojiang Li, and Mjumbe Poe; chaired by Elizabeth Delmelle. Association of Collegiate Schools of Planning Annual Conference. Minneapolis, Minnesota. Oct 23--25.

        \item[2025] \tab{}\enquote{Plenary Session: AI in Urban Planning Workshop.} Panelist. Association of Collegiate Schools of Planning Annual Conference. Minneapolis, Minnesota. Oct 22.
    ...
    \begin{tablist}
        ...
        \item[2025] \tab{}G. Boeing, \textit{J. Kim}, D. Simon-Thompson, J. Ha, and R. Chen. \enquote{Do Green Space Accessibility Analyses Vary by Which Data Source You Use?} Association of Collegiate Schools of Planning Annual Conference. Minneapolis, Minnesota. Oct 23--25.
    ...
    \begin{tablist}
        ...
        %\item[2025] \tab{}Nobel Sustainability Trust Sustainability Award
