...
\begin{document}
    ...
    \begin{tablist}
        ...
        \item[\the\year] \tab{}Boeing, G., M. Besbris, D. Wachsmuth, and J. Wegmann. \enquote{Tilted Platforms: Rental Housing Technology and the Rise of Urban Big Data Oligopolies.} \textit{Urban Transformations}, published online ahead of print. \href{https://doi.org/10.1186/s42854-021-00024-2}{doi:10.1186/s42854-021-00024-2}
    ...
    \subsection*{Keynote/Plenary Addresses}

    \begin{tablist}

        \item[2021] \tab{}\enquote{Urban Informatics and Mobilities.} Regional Studies Association Winter Conference, annual lecture series keynote address. Online. Nov 1--12.
    ...
    \begin{tablist}
        ...
        \item[2021] \tab{}\enquote{Machine Learning in Public Health.} Panelist with Jing Gao; chaired by Rumi Chunara. Conference on Neural Information Processing Systems. Online. Dec 6--14.
    ...
    \begin{tablist}
        ...
        \item[2021] \tab{}Boeing, G., \textit{Y. Lu}, C. Pilgram, P. Mannino. \enquote{Race, Class, and the Production of and Exposure to Vehicular Pollution in Los Angeles.} Association of Collegiate Schools of Planning Annual Conference. Miami, Florida. Oct 21--23.
