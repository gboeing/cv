...
\begin{document}
    ...
    \begin{tablist}
		...
		\item[2020] \tab Boeing, G. \enquote{Off the Grid... and Back Again? The Recent Evolution of American Street Network Planning and Design.} \textit{Journal of the American Planning Association}, in press. \href{https://doi.org/10.1080/01944363.2020.1819382}{doi:10.1080/01944363.2020.1819382}
    	
    	\item[2020] \tab Boeing, G. \enquote{The Right Tools for the Job: The Case for Applied Spatial Science Tool-Building.} \textit{Transactions in GIS}, in press. \href{https://doi.org/10.1111/tgis.12678}{doi:10.1111/tgis.12678}
    ...
    \subsection*{Manuscripts under Peer Review or in Preparation}
    ...
    \begin{tablist}
        ...
        \item[\the\year] \tab Boeing, G., M. Besbris, D. Wachsmuth, and J. Wegmann. \enquote{Information Age Robber Barons: Rental Housing Technology Platforms and the Rise of Urban Big Data Oligopolies.} Target: \textit{Urban Transformations} special issue on platform urbanism. Spring 2021.
    ...
    \begin{tablist}
    	...
    	\item[2020] \tab \enquote{Volunteered Geographic Information in Urban Analytics.} University of California, Berkeley, Department of City and Regional Planning. Introduction to Urban Data Analytics. Jun 17.
    ...
    \begin{tablist}
		...
		\item[2020] \tab \enquote{Urban Data Science Beyond the Hype: Understanding the Challenges and Opportunities of Incorporating Data Science into Urban Planning Pedagogy and Practice.} Panelist with Karen Chapple, Atul Pokharel, and Manuel Santana; chaired by Abigail Cochran. Association of Collegiate Schools of Planning Annual Conference. Toronto, Canada. Nov 5--8.
    ...
    \begin{itemize}
        ...
        \item Outreach and Engagement Task Force, Association of Collegiate Schools of Planning, 2019--
